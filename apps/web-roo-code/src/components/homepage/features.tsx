...
export const features: Feature[] = [
	{
		...
		description:
			"Cybrosys Assista puts a team of agentic AI assistants directly in your editor, with the power to plan, write, and fix code across multiple files.",
		size: "large",
	},
	{
		...
		description:
			"From coding to debugging to architecture, Cybrosys Assista has a mode for every dev scenario—just switch on the fly.",
		size: "small",
	},
	{
		...
		description:
			"Cybrosys Assista reads your entire codebase, preserving valid code through diff-based edits for seamless multi-file refactors.",
		size: "small",
	},
	{
		...
		description:
			"Bring your own model or use local AI—no vendor lock-in. Cybrosys Assista is free, open, and adaptable to your needs.",
		size: "large",
	},
	{
		...
		description:
			"Approve or deny commands as needed. Cybrosys Assista automates your dev workflow while keeping oversight firmly in your hands.",
		size: "small",
	},
	{
		...
		description:
			"Create or tweak modes, define usage rules, and shape Cybrosys Assista’s behavior precisely—your code, your way.",
		size: "small",
	},
	{
		...
		description:
			"Seamlessly test and verify your web app directly from VS Code—Cybrosys Assista can open a browser, run checks, and more.",
		size: "small",
	},
]
