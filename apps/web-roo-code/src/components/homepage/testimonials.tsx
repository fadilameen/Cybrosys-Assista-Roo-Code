...
export const testimonials: Testimonial[] = [
	...
	},
	{
		...
		role: "Reviewer",
		company: "VS Code Marketplace",
		quote: "I switched from Windsurf to Cybrosys Assista in January and honestly, it's been a huge upgrade. Windsurf kept making mistakes and being dumb when I ask it for things. Roo just gets it. Projects that used to take a full day now wrap up before lunch. ",
	},
]
