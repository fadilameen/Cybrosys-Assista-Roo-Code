...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping Cybrosys Assista's enterprise solution."
			: "Fill out the form below to see Cybrosys Assista's enterprise capabilities in action."
