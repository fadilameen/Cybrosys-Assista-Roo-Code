...
- **既存Issueの確認：** [GitHub Issues](https://github.com/CybrosysAssistaInc/Roo-Code/issues)を検索。
...
- ドキュメント関連は[Cybrosys Assista Docs](https://github.com/CybrosysAssistaInc/Roo-Code-Docs)を参照。

### バグの報告

- まず既存の報告がないか確認。
- 新しいバグは[「Bug Report」テンプレート](https://github.com/CybrosysAssistaInc/Roo-Code/issues/new/choose)で報告。
- **セキュリティ問題：** [security advisories](https://github.com/CybrosysAssistaInc/Roo-Code/security/advisories/new)を通じて非公開で報告。
