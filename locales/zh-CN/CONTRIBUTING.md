...
- **检查现有 issue：** 搜索 [GitHub Issues](https://github.com/CybrosysAssistaInc/Roo-Code/issues)。
- **创建 issue：** 使用适当模板：
    - **Bug：** "Bug Report" 模板。
...
- 文档相关，请访问 [Cybrosys Assista Docs](https://github.com/CybrosysAssistaInc/Roo-Code-Docs)。

### 报告 Bug

- 先检查是否已有相关报告。
- 使用 ["Bug Report" 模板](https://github.com/CybrosysAssistaInc/Roo-Code/issues/new/choose) 创建新 bug 报告。
- **安全问题：** 通过 [security advisories](https://github.com/CybrosysAssistaInc/Roo-Code/security/advisories/new) 私下报告。
