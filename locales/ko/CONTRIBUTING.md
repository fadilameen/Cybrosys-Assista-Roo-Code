...
- **기존 Issue 확인:** [GitHub Issues](https://github.com/CybrosysAssistaInc/Roo-Code/issues)를 검색하세요.
- **Issue 생성:** 적절한 템플릿 사용:
    - **버그:** "Bug Report" 템플릿.
...
- 문서 관련은 [Cybrosys Assista Docs](https://github.com/CybrosysAssistaInc/Roo-Code-Docs)를 참조하세요.

### 버그 신고

- 먼저 기존 신고를 확인하세요.
- ["Bug Report" 템플릿](https://github.com/CybrosysAssistaInc/Roo-Code/issues/new/choose)을 사용하여 새 버그를 신고하세요.
- **보안 문제:** [security advisories](https://github.com/CybrosysAssistaInc/Roo-Code/security/advisories/new)를 통해 비공개로 신고하세요.
