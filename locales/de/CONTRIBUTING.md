...
- **Bestehende Issues prüfen**: Durchsuche die [GitHub Issues](https://github.com/CybrosysAssistaInc/Roo-Code/issues).
...
- Für Dokumentation besuche das [Cybrosys Assista Docs](https://github.com/CybrosysAssistaInc/Roo-Code-Docs) Repository.

### Bugs melden

- Prüfe zuerst, ob der Bug bereits gemeldet wurde.
- Erstelle neue Bug-Reports mit der ["Bug Report"-Vorlage](https://github.com/CybrosysAssistaInc/Roo-Code/issues/new/choose).
- **Sicherheitslücken:** Melde diese privat über [Security Advisories](https://github.com/CybrosysAssistaInc/Roo-Code/security/advisories/new).
