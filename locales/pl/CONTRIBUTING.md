...
- **Sprawdź istniejące issues:** Przeszukaj [GitHub Issues](https://github.com/CybrosysAssistaInc/Roo-Code/issues).
...
- W kwestii dokumentacji odwiedź [Cybrosys Assista Docs](https://github.com/CybrosysAssistaInc/Roo-Code-Docs).

### Zgłaszanie błędów

- Najpierw sprawdź istniejące zgłoszenia.
- Twórz nowe zgłoszenia błędów używając [szablonu "Bug Report"](https://github.com/CybrosysAssistaInc/Roo-Code/issues/new/choose).
- **Luki bezpieczeństwa:** Zgłaszaj prywatnie przez [security advisories](https://github.com/CybrosysAssistaInc/Roo-Code/security/advisories/new).
