...
- **मौजूदा Issues देखें:** [GitHub Issues](https://github.com/CybrosysAssistaInc/Roo-Code/issues) में खोजें।
...
- डॉक्युमेंटेशन के लिए, [Cybrosys Assista Docs](https://github.com/CybrosysAssistaInc/Roo-Code-Docs) देखें।

### बग या समस्या रिपोर्ट करना

- पहले मौजूदा रिपोर्ट देखें।
- ["Bug Report" टेम्पलेट](https://github.com/CybrosysAssistaInc/Roo-Code/issues/new/choose) का उपयोग करके नए बग रिपोर्ट बनाएं।
- **सुरक्षा कमजोरियां:** [security advisories](https://github.com/CybrosysAssistaInc/Roo-Code/security/advisories/new) के माध्यम से निजी तौर पर रिपोर्ट करें।
