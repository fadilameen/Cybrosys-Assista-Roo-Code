...
- **檢查現有 issue：** 搜尋 [GitHub Issues](https://github.com/CybrosysAssistaInc/Roo-Code/issues)。
- **建立 issue：** 使用適當範本：
    - **Bug：** 「Bug Report」範本。
...
- 文件相關，請訪問 [Cybrosys Assista Docs](https://github.com/CybrosysAssistaInc/Roo-Code-Docs)。

### 回報 Bug

- 先檢查是否已有相關報告。
- 使用 [「Bug Report」範本](https://github.com/CybrosysAssistaInc/Roo-Code/issues/new/choose) 建立新 bug 報告。
- **安全問題：** 透過 [security advisories](https://github.com/CybrosysAssistaInc/Roo-Code/security/advisories/new) 私下回報。
