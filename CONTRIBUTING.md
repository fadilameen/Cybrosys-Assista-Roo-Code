...
- **Check existing issues**: Search [GitHub Issues](https://github.com/CybrosysAssistaInc/Roo-Code/issues).
...
- For docs, visit [Cybrosys Assista Docs](https://github.com/CybrosysAssistaInc/Roo-Code-Docs).

### Reporting Bugs

- Check for existing reports first.
- Create new bugs using the ["Bug Report" template](https://github.com/CybrosysAssistaInc/Roo-Code/issues/new/choose).
- **Security issues**: Report privately via [security advisories](https://github.com/CybrosysAssistaInc/Roo-Code/security/advisories/new).
