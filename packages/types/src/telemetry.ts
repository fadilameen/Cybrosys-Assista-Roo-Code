...
/**
 * CybrosysAssistaTelemetryEvent
 */

export const cybrosysAssistaTelemetryEventSchema = z.discriminatedUnion("type", [
	z.object({
		type: z.enum([
...
export type CybrosysAssistaTelemetryEvent = z.infer<typeof cybrosysAssistaTelemetryEventSchema>
