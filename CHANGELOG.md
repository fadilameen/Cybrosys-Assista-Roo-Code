...
- Add opt-in telemetry to help us improve Cybrosys Assista faster (thanks Cline!)
...
- Add support for a .rooignore to prevent Cybrosys Assista from read/writing certain files, with a setting to also exclude them from search/lists (thanks Cline!)
...
- Fix context window truncation math (see [#1173](https://github.com/CybrosysAssistaInc/Roo-Code/issues/1173))
...
- **Name Change From Roo Cline to Cybrosys Assista:** We're excited to announce our new name! After growing beyond 50,000 installations, we've rebranded from Roo Cline to Cybrosys Assista to better reflect our identity as we chart our own course.
...
Join us at https://www.reddit.com/r/CybrosysRoo to share your custom modes and be part of our next chapter!
...
- Incorporate Premshay's [PR](https://github.com/CybrosysAssistaInc/Roo-Code/pull/60) to add support for Amazon Nova and Meta Llama Models via Bedrock (3, 3.1, 3.2) and unified Bedrock calls using BedrockClient and Bedrock Runtime API
...
- Incorporate dbasclpy's [PR](https://github.com/CybrosysAssistaInc/Roo-Code/pull/54) to add support for gemini-exp-1206
...
- Fix https://github.com/CybrosysAssistaInc/Roo-Code/issues/50 where sound effects were not respecting settings
...
- Incorporate lloydchang's [PR](https://github.com/CybrosysAssistaInc/Roo-Code/pull/42) to add support for OpenRouter compression
